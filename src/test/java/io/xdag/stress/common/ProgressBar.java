...
public class ProgressBar {
     ...
     * @return 进度条结果
     */
    public void showBarByPoint(String prefix, double currentPoint) {
        // 根据进度参数计算进度比率
        ...
        // 生成进度条
        System.out.print("\r");
        System.out.print(makeBarBySignAndLength(prefix,barSign) + String.format(" %.2f%%", rate * 100));
    }
     ...
     * @return 字符型进度条
     */
    private String makeBarBySignAndLength(String prefix,int barSign) {
